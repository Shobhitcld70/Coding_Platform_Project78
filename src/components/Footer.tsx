    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              VIT Code Hub is a platform for VIT Bhopal students to collaborate, share code, and learn together.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/code-sharing" className="text-gray-400 hover:text-white">Code Sharing</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} VIT Code Hub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
